...
class RalphConfig:
    ...
    rope_base: float = 10_000.0  # recipe-v4: RoPE-100k (was 10k)
    rms_norm_eps: float = 1e-5
    init_std: float = 0.02
    tie_embeddings: bool = True
    unet_skip: bool = False        # recipe-v4: U-Net learnable skip connections
    logit_softcap: float = 0.0   # recipe-v4: tanh soft-cap on logits (0 = off)
