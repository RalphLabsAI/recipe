...
def train(cfg: TrainConfig, out_dir: Path, use_wandb: bool = False) -> dict:
    ...
    # op1 check_canonical_data_source rejects absolute paths; record the canonical
    # data tree as container-relative (runner supplies an absolute --manifest for
    # shard binding; manifest_hash still binds the bytes).
