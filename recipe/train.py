...
def train(cfg: TrainConfig, out_dir: Path, use_wandb: bool = False) -> dict:
    ...
    # default torch.compile: max-autotune is ~1.8x SLOWER here (conflicts with
    # use_deterministic_algorithms -> slow deterministic-kernel fallbacks + autotune overhead).
